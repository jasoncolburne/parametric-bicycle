...
_TUBE_SOCKET_DEPTH = 3;
_TUBE_SOCKET_CLEARANCE = 4;
_TUBE_EXTENSION_DEPTH = 5;
_TUBE_COLLAR_THICKNESS = 6;
_TUBE_BOLT_SIZE = 7;

// Constructor
function TubeSize(outer_r, thickness, inner_sleeve_depth, socket_depth, socket_clearance, extension_depth, collar_thickness, bolt_size) =
    [outer_r, thickness, inner_sleeve_depth, socket_depth, socket_clearance, extension_depth, collar_thickness, bolt_size];
