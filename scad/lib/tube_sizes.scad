...
_TUBE_THICKNESS = 1;
_TUBE_SOCKET_DEPTH = 2;
_TUBE_SOCKET_CLEARANCE = 3;
_TUBE_EXTENSION_DEPTH = 4;
_TUBE_COLLAR_THICKNESS = 5;
_TUBE_BOLT_SIZE = 6;

// Constructor
function TubeSize(outer_r, thickness, socket_depth, socket_clearance, extension_depth, collar_thickness, bolt_size) =
    [outer_r, thickness, socket_depth, socket_clearance, extension_depth, collar_thickness, bolt_size];
