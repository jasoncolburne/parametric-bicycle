...
// Lug dimensions
lug_height = 90;             // Height along head tube (increased for top tube clearance)
...
module head_tube_lug() {
    ...
    seat_height = 50;  // Height from bottom to seating step (90mm - 40mm clamping = 50mm)
    ...
    difference() {
        ...
        union() {
            ...
            translate([bolt_x, 0, lug_height * 0.75])
                rotate([90, 0, 0]) {
                    // Main cylinder
            ...
            top_tube_socket_radius = (top_tube_od + 12) / 2;
        ...
        socket_offset = lug_collar_radius - top_tube_socket_radius;
        translate([0, 0, lug_height])
            rotate([0, tt_angle, 0])
